...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void destapar(int opcion){
            if (opcion == ubicacion) {
                ...
                //Se utiliza una suma para descartar todos las opciones menos la seleccionada de manera aleatoria
                suma = suma - opcion;
                //Se compara si la resta ya descarto todas las opciones
                if (suma == ubicacion){
                    ...
                    for (int i = 1; i <= 12; i++) {
                        ImageButton btnSeleccion = (ImageButton) findViewById((
                                getResources().getIdentifier("opcion" + i, "id", this.getPackageName())));
                            btnSeleccion.setBackgroundResource(R.drawable.ganaste);
                        }
                    }else{
